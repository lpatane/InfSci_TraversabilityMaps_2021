classdef SimulationDriver
	...
	methods(Access = public)
       ...
       function [this]=OriRover(this)
            [erroreCode,handle1]=this.vrep.simxGetObjectHandle(this.clientID,'base',this.vrep.simx_opmode_oneshot_wait);
...
% %          velocitaangolare_r1=sqrt(angVelVector_r1(1).^2+angVelVector_r1(2).^2+angVelVector_r1(3).^2);  %OK, formula verificata
       ...
       function [this] = PosRoverECuboi(this,posini, posfin, alfaAngle, betaAngle,gammaAngle)
            [~,handle1]=this.vrep.simxGetObjectHandle(this.clientID,'base',this.vrep.simx_opmode_oneshot_wait);  
