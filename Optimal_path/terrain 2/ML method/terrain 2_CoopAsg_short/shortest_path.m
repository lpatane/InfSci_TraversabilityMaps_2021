...
%     coord(1, 2)=randi([1 101],1,1);
      ...
      load (['..\..\Create_Maps\maps\terrain2\thresholded maps\Mappe_sogliate_CoopAsg\mappe_asguard_soglia09\nord']) %queste sono le mappe uscenti da trasfomrazione.m
      load (['..\..\Create_Maps\maps\terrain2\thresholded maps\Mappe_sogliate_CoopAsg\mappe_asguard_soglia09\sud'])
      load (['..\..\Create_Maps\maps\terrain2\thresholded maps\Mappe_sogliate_CoopAsg\mappe_asguard_soglia09\est'])
      load (['..\..\Create_Maps\maps\terrain2\thresholded maps\Mappe_sogliate_CoopAsg\mappe_asguard_soglia09\ovest'])
      load (['..\..\Create_Maps\maps\terrain2\thresholded maps\Mappe_sogliate_CoopAsg\mappe_asguard_soglia09\nord_est'])
      load (['..\..\Create_Maps\maps\terrain2\thresholded maps\Mappe_sogliate_CoopAsg\mappe_asguard_soglia09\nord_ovest'])
      load (['..\..\Create_Maps\maps\terrain2\thresholded maps\Mappe_sogliate_CoopAsg\mappe_asguard_soglia09\sud_est'])
      load (['..\..\Create_Maps\maps\terrain2\thresholded maps\Mappe_sogliate_CoopAsg\mappe_asguard_soglia09\sud_ovest'])
